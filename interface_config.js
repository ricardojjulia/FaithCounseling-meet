...
var interfaceConfig = {
    ...
    BRAND_WATERMARK_LINK: 'https://faithcounseling.app',
    ...
    JITSI_WATERMARK_LINK: 'https://faithcounseling.app',
     ...
     * attempting to join a conference in a mobile Web browser. Disabled for
     * Faith Counseling — sessions are always browser-based.
     *
     * @type {boolean}
     */
    ...
    POLICY_LOGO: null,
    PROVIDER_NAME: 'Faith Counseling',
    ...
    SETTINGS_SECTIONS: [ 'devices', 'language', 'profile', 'sounds', 'more' ],
     ...
     * help.
     */
    SUPPORT_URL: 'https://faithcounseling.app/support',
